...
// The PNG lives as a real file (assets/hkag-logo-email.png), read + base64'd
// here at require-time rather than pasted inline as a giant string literal —
// an earlier version did that and the string came out silently truncated a
// few characters short (invalid base64 padding), which Cloudinary rejected
// with "Could not decode base64". Reading the actual file sidesteps that.
const LOGO_PATH = path.join(__dirname, 'assets', 'hkag-logo-email.png');
