...
// Company logo, embedded as a base64 PNG (rasterized once from the client's
// own HKAG logo SVG, trimmed to its content box) so the footer doesn't
// depend on Cloudinary or any external URL staying reachable — it's baked
// straight into every e-mail's HTML instead of linked.
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; font-size: 14px; color: #222;">
      ...
      <div style="margin-top: 20px; padding-top: 16px; border-top: 1px solid #e5e5e5;">
        <img src="${LOGO_DATA_URI}" alt="HKAG — Hong Kong Alliance Global Trading Co. Ltd." width="180" style="display:block; width:180px; height:auto;" />
